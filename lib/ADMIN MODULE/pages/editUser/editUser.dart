...
import 'package:gc_369/ADMIN%20MODULE/pages/toatalUsers.dart';
...
class EditUser extends StatefulWidget {
  static const String id = "NewProfile";
...
class _EditUserState extends State<EditUser> {
  ...
  void initState() {
    ...
    joinDateController = TextEditingController(
        text:widget.user.joinDate.toString().length<10?widget.user.joinDate.toString(): widget.user.joinDate.toString().substring(0, 10));
    ...
    fullAddressController =
        TextEditingController(text: widget.user?.address?['hname']??"");
    pinCodeController = TextEditingController(text: widget.user?.address?['pincode']??"");

    stateController = TextEditingController(text: widget.user?.address?['state']??"");
    districtController = TextEditingController(text: widget.user?.address?['city']??"");
