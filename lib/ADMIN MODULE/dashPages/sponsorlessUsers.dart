...
class _sponsorlessUsersPageState extends State<sponsorlessUsersPage> {
  ...
  _launchURLBrowser(String userId) async {
    var url = Uri.parse("https://www.369globalclub.org/#/adminUserPanel?$userId");
                        ...
                        builder: (context, snapshot) {
                          ...
                          return DataTable(
                            ...
                            rows: List.generate(data.length, (index) {
                              TextEditingController sponsorId$index =TextEditingController();
                              var user = data[index];
                                  ...
                                  ElevatedButton(onPressed: () async {
                                    ...
                                    if(sponsorId$index.text!=''){
                                      DocumentSnapshot doc =await FirebaseFirestore
                                          ...
                                          .doc(sponsorId$index.text.toUpperCase())
                                          .get();
                                      ...
                                      if(doc.exists){
                                        FirebaseFirestore.instance
                                            ...
                                            .doc(user['uid'])
                                            .update({
                                          'spnsr_Id':sponsorId$index.text.toUpperCase(),
                                          'spnsrId2':doc['spnsr_Id'],
                                          'spnsrId3':doc['spnsrId2'],
                                        });
                                        showUploadMessage('Sponsor Updated... \n Sponsor name :${doc.get('name')}', context);

                                      }else{
                                        showUploadMessage('No User Found', context);
                                      }
                                    }else{
                                      showUploadMessage('Please Enter Sponsor Id', context);
                                    }
