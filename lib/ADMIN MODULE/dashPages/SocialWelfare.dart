...
class SocialWelfare extends StatefulWidget {
  const SocialWelfare({Key? key}) : super(key: key);

  @override
  State<SocialWelfare> createState() => _SocialWelfareState();
}
...
getHelp(List<DocumentSnapshot> data, int index, BuildContext context,
  ...
  if (transaction['amt'] ==
    ...
    if (transaction['type'] == 9) {
      getWelfare(transaction, data, index, sendUsermodel);
    }
...
getWelfare(Map<String, dynamic> transaction, List<DocumentSnapshot> data,
