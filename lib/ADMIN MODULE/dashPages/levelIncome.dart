...
class LevelIncome extends StatefulWidget {
  const LevelIncome({Key? key}) : super(key: key);

  @override
  State<LevelIncome> createState() => _LevelIncomeState();
}

class _LevelIncomeState extends State<LevelIncome> {
